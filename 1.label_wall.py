...
if __name__ == "__main__":
    ...
    parser.add_argument("-c", type=str, metavar='default.config',
    ...
    if args.t:
        ...
        pcd_labeled = label_wall(pcd_room, pcd_wall_mask, distance_threshold=args.d, preview_mode=True)
        ...
        pcd_labeled = label_wall(pcd_room, pcd_wall_mask, distance_threshold=args.d)
